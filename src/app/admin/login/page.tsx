      ...
      <div className="max-w-md w-full mx-4 relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-purple-600 text-white font-bold text-2xl mb-4 shadow-lg"
          >
            SF
          </motion.div>
        ...
        >
          ...
          <Link href="/admin/signup" className="font-semibold text-blue-600 hover:text-purple-600 transition-colors">
            Create one now →
          </Link>
        </motion.p>
